...
cd "$(dirname "$0")/.."
log="/tmp/alttab-community-run.log"
fifo="/tmp/alttab-community-run.fifo"
...
open -n --stdout "$fifo" --stderr "$fifo" -a "$PWD/DerivedData/Build/Products/Debug/AltTab Community.app" \
